...
sed -i s/BOOSTRAP_SRCROUTINE_ROOT_PLACEHOLDER/$SRCROUTINE_ROOT/g $SRCROUTINE_ROOT/lib/env
sed -i s/BOOSTRAP_SRCROUTINE_ROOT_PLACEHOLDER/$SRCROUTINE_ROOT/g $BIN_DIR/srcroutine
